...
const projects = [
  ...
  },
  {
    ...
    description: "This project highlights the Istanbul Commerce University Statistics Program, offering a concise overview of its structure, scope, and opportunities for students and stakeholders.",
    technologies: ["Next.js", "Tailwind CSS"],
    image: "/Ticaret-Istatistik.jpg",
    buttons: [
      { name: "GitHub", to: "https://github.com/ticaretistatistik/ticaretistatistik.github.io" },
          ...
          >
            ...
            {project.image && (
              <div className="md:w-1/2 w-full flex justify-center items-center">
                <div className="overflow-hidden rounded-xl shadow-md w-full h-full">
                  <Image
                    src={project.image}
                    alt={project.title}
                    width={640}
